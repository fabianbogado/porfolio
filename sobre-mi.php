        ...
        <div class="row">
            <div class="col-12 col-sm-5">
                    ...
                    <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                        <img src="imagenes/fabian-bogado.jpg" alt="Fabian bogado" title="Fabian bogado"class="img-fluid img-circle"</div> <!--no me tomaba el css-->
        </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-2 p-5 my-auto d-none d-sm-block">
                            <img src="imagenes/sin-logo.png" class="img-fluid baw" title="sin-logo">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Atencion/Reposioción en un minimercado</h3>
                            <h4>2021-2022</h4>
                            <p>Repocitor y atencion al cliente en un minimercado del barrio durante las vacaciones</p>
                        </div>
                    </div>
                </div>   
            </div>
            ...
            <div class="row shadow bg-white rounded p-1">
                <div class="col-12 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Formacion Secundaria</h3>
                            <h4>Escuela secundaria N15 "Frida kahlo"</h4>
                            <h5>2018 – 2021</h5>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-12- col-sm-10 p-3">
                            <h3>Conputacion/Informatica basica</h3>
                            <h4>England</h4>
                            <h5>2019 – 2021</h5>
                            <p> HIghlan <br></p>
                        </div>
